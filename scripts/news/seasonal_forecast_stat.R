...
#options(future.globals.maxSize = 5 * 1024^3)  # 2GB (exemple)
...
#                                                 topK = 1,
#                                                 quiet = FALSE,
#                                                 min_kge_model =0,use_sub_fuser =FALSE,
...
# ids <- c("1040571730","1040633360","1040644790")
# data_by_products_ <- data_by_products[ids]
